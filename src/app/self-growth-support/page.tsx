    ...
    const fetchSelfGrowthResources = async () => {
      ...
      try {
        ...
        const fetchedResources = allResources.filter(res =>
          selfGrowthRelatedTopics.some(topic => res.topic.toLowerCase().includes(topic))
        );
        ...
        <div className="space-y-8">
          <section className="relative bg-card p-6 sm:p-10 rounded-xl shadow-lg overflow-hidden">
            <div className="absolute inset-0 opacity-10">
              <Image src="https://placehold.co/1200x300.png?text=+" data-ai-hint="growth journey abstract" alt="Abstract background" layout="fill" objectFit="cover" />
            </div>
