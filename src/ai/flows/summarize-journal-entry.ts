...
/**
 * @fileOverview Summarizes a user's journal entry using AI.
 *
 * - summarizeJournalEntry - A function that handles the summarization process.
...
const SummarizeJournalEntryInputSchema = z.object({
  journalEntry: z
    .string()
    .describe('The journal entry to summarize.'),
});
